...
## 2026-09-12 — статус тренировок и пересборка остатка сентября

- 01_raw/trainings + 02_sources | отчёт владельца: на 12.09 закрыты Dust 2, Inferno и Nuke;
  слоты Mirage (02.09) и Anubis (09.09) не состоялись.
  [source: /02_sources/2026-09-12-training-status-owner.md]
- 00_context + 03_wiki/map-pool-2026 | Nuke помечена отработанной (2026-09-06); зафиксирован риск:
  обе карты наших пиков на первые матчи — Cache (30.09) и Anubis (01.10) — не отработаны.
- site/ | остаток сентября пересобран под вето: 13.09 Ancient → Anubis, 16.09 Cache (пик на 30.09),
  20.09 Inferno + первый проход Mirage, Ancient перенесён в октябрьское окно (04.10);
  обновлены `meta.today` и заметка «Ресурс до старта».
