...
- 04_synthesis | добавлен зеркальный скаутинг «Как нас видят соперники»: наш профиль, векторы атаки
  на нас и вето их глазами; зафиксировано, что перевес в открытии раундов держится на одном игроке.
  [source: /03_wiki/metric-equivalent-team-matches.md]
- 04_synthesis/contradictions | C3: `estimated_strength` занижает «Рассадник добра» (якорь на драфт
  1.002 при фактическом recent-рейтинге 1.313), из-за чего покартовый знак против них расходится
  с пересчётом по фактической форме. [source: /02_sources/2026-08-29-cs2-whoajor-intelligence.md]
- site/ + scripts/whoajor | новый вычисляемый датасет `mirrorScouting` (4 строки, по одной на
  соперника) и раздел «Как нас видят» в штабе: зеркальные map edge, попарное сравнение метрик,
  кого соперник будет фокусить и кого хантить. Каждое утверждение цитирует существующий evidence-ID.
