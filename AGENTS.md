...
`site/` — штаб команды (https://ushibu-nogami-hq.vercel.app): закрытый паролями сайт с планом
подготовки, плейбуками и кодексом. Это **деплоймент, а не слой KB**: пирамида `01→05`, метки и
внутренние цитаты на него не распространяются, семантический индекс его не читает. Правила
и деплой — `site/README.md`.
