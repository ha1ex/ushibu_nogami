...
subtitle: "You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using ASCII art."
source: https://github.com/danielmiessler/fabric/blob/main/data/patterns/create_visualization/system.md
upstream_name: "create_visualization"
provider: fabric
license: MIT
