...
subtitle: "You are an expert at data and concept visualization and in turning complex ideas into a form that can be visualized using Mermaid (markdown) syntax."
source: https://github.com/danielmiessler/fabric/blob/main/data/patterns/create_mermaid_visualization_for_github/system.md
upstream_name: "create_mermaid_visualization_for_github"
provider: fabric
license: MIT
