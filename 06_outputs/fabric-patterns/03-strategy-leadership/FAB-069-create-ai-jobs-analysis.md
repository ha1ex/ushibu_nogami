...
subtitle: "You are an expert on AI and the effect it will have on jobs."
source: https://github.com/danielmiessler/fabric/blob/main/data/patterns/create_ai_jobs_analysis/system.md
upstream_name: "create_ai_jobs_analysis"
provider: fabric
license: MIT
...
> You are an expert on AI and the effect it will have on jobs.
