...
subtitle: "You take guidance and/or an author name as input and design a perfect three-phase reading plan for the user using the STEPS below."
source: https://github.com/danielmiessler/fabric/blob/main/data/patterns/create_reading_plan/system.md
upstream_name: "create_reading_plan"
provider: fabric
license: MIT
