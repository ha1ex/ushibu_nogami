...
kind: workflow
title: "Transcribe an audio file with Deepgram & use Anthropic to prepare interview questions!"
subtitle: "**Make a copy of this notebook into your own drive, and follow the instructions below!** 🥳🥳🥳 ---------------------------- # Get started: Running the following three cells will allow you to transcri..."
source: https://github.com/anthropics/claude-cookbooks/blob/main/third_party/Deepgram/prerecorded_audio.ipynb
upstream_name: "third_party/Deepgram/prerecorded_audio.ipynb"
...
> **Make a copy of this notebook into your own drive, and follow the instructions below!** 🥳🥳🥳 ---------------------------- # Get started: Running the following three cells will allow you to transcri...
