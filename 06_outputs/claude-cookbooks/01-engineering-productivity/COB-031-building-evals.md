...
subtitle: "Optimizing Claude to give you the highest possible accuracy on a task is an empirical science, and a process of continuous improvement."
source: https://github.com/anthropics/claude-cookbooks/blob/main/misc/building_evals.ipynb
upstream_name: "misc/building_evals.ipynb"
...
> Optimizing Claude to give you the highest possible accuracy on a task is an empirical science, and a process of continuous improvement.
