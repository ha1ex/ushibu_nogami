...
subtitle: "Claude 3.7 Sonnet may be less likely to make make parallel tool calls in a response, even when you have not set `disable_parallel_tool_use`."
source: https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/parallel_tools.ipynb
upstream_name: "tool_use/parallel_tools.ipynb"
...
> Claude 3.7 Sonnet may be less likely to make make parallel tool calls in a response, even when you have not set `disable_parallel_tool_use`.
