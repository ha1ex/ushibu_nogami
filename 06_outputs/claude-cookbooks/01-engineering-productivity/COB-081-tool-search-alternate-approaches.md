...
subtitle: "**Recommend first reading see the cookbook: Tool Search with Embeddings.** The goal of this cookbook is to show of some alternate approaches to using tool search (or really \"tool discovery\") with C..."
source: https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/tool_search_alternate_approaches.ipynb
upstream_name: "tool_use/tool_search_alternate_approaches.ipynb"
...
> **Recommend first reading see the cookbook: Tool Search with Embeddings.** The goal of this cookbook is to show of some alternate approaches to using tool search (or really "tool discovery") with C...
