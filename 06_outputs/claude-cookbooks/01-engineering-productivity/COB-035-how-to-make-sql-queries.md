...
subtitle: "In this notebook, we'll explore how to use Claude to generate SQL queries based on natural language questions."
source: https://github.com/anthropics/claude-cookbooks/blob/main/misc/how_to_make_sql_queries.ipynb
upstream_name: "misc/how_to_make_sql_queries.ipynb"
...
> In this notebook, we'll explore how to use Claude to generate SQL queries based on natural language questions.
