...
subtitle: "[DISCLAIMER: This notebook was created using Claude 2 models and is considered legacy.] Some questions can't be answered by Claude off the top of Claude's head."
source: https://github.com/anthropics/claude-cookbooks/blob/main/third_party/Wikipedia/wikipedia-search-cookbook.ipynb
upstream_name: "third_party/Wikipedia/wikipedia-search-cookbook.ipynb"
...
> [DISCLAIMER: This notebook was created using Claude 2 models and is considered legacy.] Some questions can't be answered by Claude off the top of Claude's head.
