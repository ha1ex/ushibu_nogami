...
subtitle: "Imagine you have a prompt roughly along these lines: \"\"\"Here's some things I want you to analyze: <thing> {{thing1}} </thing> <thing> {{thing2}} </thing> These things are [description of things]."
source: https://github.com/anthropics/claude-cookbooks/blob/main/misc/generate_test_cases.ipynb
upstream_name: "misc/generate_test_cases.ipynb"
...
> Imagine you have a prompt roughly along these lines: """Here's some things I want you to analyze: <thing> {{thing1}} </thing> <thing> {{thing2}} </thing> These things are [description of things].
