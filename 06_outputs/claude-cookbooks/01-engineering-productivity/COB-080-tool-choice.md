...
kind: workflow
title: "Tool choice"
subtitle: "Tool use supports a parameter called `tool_choice` that allows you to specify how you want Claude to call tools."
source: https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/tool_choice.ipynb
upstream_name: "tool_use/tool_choice.ipynb"
...
> Tool use supports a parameter called `tool_choice` that allows you to specify how you want Claude to call tools.
