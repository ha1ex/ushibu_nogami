...
kind: workflow
title: "Context Editing & Memory for Long-Running Agents"
subtitle: "AI agents that run across multiple sessions or handle long-running tasks face two key challenges: they lose learned patterns between conversations, and context windows fill up during extended inter..."
source: https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/memory_cookbook.ipynb
upstream_name: "tool_use/memory_cookbook.ipynb"
...
> AI agents that run across multiple sessions or handle long-running tasks face two key challenges: they lose learned patterns between conversations, and context windows fill up during extended inter...
