...
kind: workflow
title: "Low Latency Voice Assistant with ElevenLabs and Claude"
subtitle: "This notebook demonstrates how to build a low-latency voice assistant using ElevenLabs for speech-to-text and text-to-speech, combined with Claude for intelligent responses."
source: https://github.com/anthropics/claude-cookbooks/blob/main/third_party/ElevenLabs/low_latency_stt_claude_tts.ipynb
upstream_name: "third_party/ElevenLabs/low_latency_stt_claude_tts.ipynb"
...
> This notebook demonstrates how to build a low-latency voice assistant using ElevenLabs for speech-to-text and text-to-speech, combined with Claude for intelligent responses.
