...
subtitle: "This cookbook demonstrates \"Speculative Prompt Caching\" - a pattern that reduces time-to-first-token (TTFT) by warming up the cache while users are still formulating their queries."
source: https://github.com/anthropics/claude-cookbooks/blob/main/misc/speculative_prompt_caching.ipynb
upstream_name: "misc/speculative_prompt_caching.ipynb"
