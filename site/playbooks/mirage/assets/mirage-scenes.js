  ...
  window.MIRAGE_SCENES = {
    ...
    tDefault: {
      labels: [
        ...
        point('t-b', 'Ковры B · 1', 0.286, 0.086, 0.410, 0.047, 't')
      ],
      routes: [
        route('t-route-a', [[0.909, 0.296], [0.830, 0.420], [0.752, 0.637]], 't'),
        route('t-route-mid', [[0.909, 0.296], [0.790, 0.325], [0.690, 0.355]], 't'),
        route('t-route-b', [[0.909, 0.296], [0.885, 0.155], [0.730, 0.130], [0.475, 0.095], [0.286, 0.086]], 't')
      ]
    },
    midControl: {
      labels: [
        point('mid-window', 'Окно · закрыть', 0.381, 0.405, 0.265, 0.430, 'ct'),
        point('mid-connector', 'Коннектор · проверить', 0.485, 0.510, 0.700, 0.528, 'signal'),
    ...
    aExecute: {
      labels: [
        ...
        point('a-plant', 'Плент · дефолт A', 0.568, 0.748, 0.550, 0.860, 't')
      ],
      routes: [
      ...
      pins: [
        ...
        pin('5', 0.535, 0.595, 'Reconnecting · гранаты', 0.620, 0.565, 'start', 'Reconnecting')
      ]
    },
    bExecute: {
      labels: [
        ...
        point('b-arch', 'Правый проход · смок', 0.290, 0.188, 0.410, 0.085, 'signal'),
      ...
      pins: [
        ...
        pin('2', 0.245, 0.125, 'D4ba · размен', 0.390, 0.155, 'end', 'D4ba'),
        pin('3', 0.205, 0.190, 'd0lfero · бомба', 0.340, 0.260, 'start', 'd0lfero'),
    ...
    ctDefault: {
      labels: [
        point('ct-a', 'A · 2', 0.525, 0.730, 0.450, 0.700, 'ct'),
